!(function() {
    ...
    function e(e) {
        ...
        ;(this.numFrames = function() {
            ...
            (this.frameInfo = function(e) {
                if (e < 0 || e >= l.length) throw 'Frame index out of range.'
                return l[e]
            }),
    ...
    function t(e, t, s, i) {
        for (
            ...
            for (; l < 16 && 0 !== m; )
                (c |= e[t++] << l), (l += 8), 1 === m ? (m = e[t++]) : --m
            if (l < o) break
            var f = c & d
            if (((c >>= o), (l -= o), f !== a)) {
                if (f === r) break
                for (var v = f < h ? f : _, g = 0, y = v; y > a; ) (y = p[y] >> 8), ++g
                var b = y
                if (u + g + (v !== f ? 1 : 0) > i)
                ...
                null !== _ &&
                    h < 4096 &&
                    ((p[h++] = (_ << 8) | b),
                    h >= d + 1 && o < 12 && (++o, (d = (d << 1) | 1))),
                    (_ = f)
            } else (h = r + 1), (d = (1 << (o = n + 1)) - 1), (_ = null)
        }
        return u !== i && console.log('Warning, gif stream shorter than expected.'), s
    }
    var s = function() {
        ...
        class s extends HTMLElement {
            ...
            constructor() {
                ...
                e.appendChild(document.importNode(t.content, !0)),
                    ...
                    (this._canvas = e.querySelector('canvas')),
            ...
            connectedCallback() {
                ;(this.style.display = 'inline-block'),
                    ...
                    this.addEventListener('touchstart', this.pausePlaybackBound, !1),
                    this.addEventListener('touchmove', this.moveBound, !1),
                    this.addEventListener('touchend', this.resumePlaybackBound, !1),
                    this.addEventListener('mouseenter', this.pausePlaybackBound, !1),
                    this.addEventListener('mousemove', this.moveBound, !1),
                    this.addEventListener('mouseleave', this.resumePlaybackBound, !1)
            }
            disconnectedCallback() {
                this.removeEventListener('touchstart', this.pausePlaybackBound, !1),
                    this.removeEventListener('touchmove', this.moveBound, !1),
                    this.removeEventListener('touchend', this.resumePlaybackBound, !1),
                    this.removeEventListener('mouseenter', this.pausePlaybackBound, !1),
                    this.removeEventListener('mousemove', this.moveBound, !1),
                    this.removeEventListener('mouseleave', this.resumePlaybackBound, !1)
            }
            ...
            move(e) {
                e.preventDefault()
                var t
                t = e.targetTouches ? e.targetTouches[0].clientX : e.clientX
                var s = this.getBoundingClientRect(),
                    i = (t - s.left) / s.width
                this.frame = Math.round((this._frames.length - 1) * i)
            }
            load(t) {
                this._reset(),
                    this.dispatchEvent(
                ...
                var s = { method: 'GET', mode: 'cors', cache: 'default' }
                fetch(t, s)
                    .then(e => e.arrayBuffer())
                    .then(e => new Uint8Array(e))
                    .then(t => new e(t))
                    .then(e => this.process(e))
            ...
            process(e) {
                ...
                switch (
                    ...
                    case 'cover':
                        t > s
                            ? ((i = this.clientHeight * t),
                              (n = this.clientHeight),
                              (this._canvas.style.top = 0),
                              (this._canvas.style.left =
                                  -(i - this.clientWidth) / 2 + 'px'))
                            : ((i = this.clientWidth),
                              (n = this.clientWidth / t),
                              (this._canvas.style.top =
                                  -(n - this.clientHeight) / 2 + 'px'),
                              (this._canvas.style.left = 0)),
                    ...
                    case 'contain':
                        ...
                        t > s
                            ? ((i = this.clientWidth),
                              (n = this.clientWidth / t),
                              (this._canvas.style.top =
                                  (this.clientHeight - n) / 2 + 'px'),
                              (this._canvas.style.left = 0))
                            : ((i = this.clientHeight * t),
                              (n = this.clientHeight),
                              (this._canvas.style.top = 0),
                              (this._canvas.style.left =
                                  (this.clientWidth - i) / 2 + 'px')),
                            (this._canvas.style.width = i + 'px'),
                            (this._canvas.style.height = n + 'px')
                        break
                    case 'stretch':
                ...
                var a = e.numFrames()
                ;(this._decoded = -1),
                    (this._delays = new Array(a)),
                    (this._frames = new Array(a)),
                    this._frame < 0 && (this._frame = this._frames.length + this._frame)
                ...
                this.dispatchEvent(r),
                    this._onload && this._onload(r),
                    this._play
                        ? this.start()
                        : this.displayFrame(this._frames, this._frame),
                    this._prerender && requestIdleCallback(this.prerenderFramesBound)
            }
            start() {
            ...
            resumePlayback(e) {
                ;(this.paused = !1),
                    this.playing && this.playAnimation(this._frames, this._frame)
            }
            playLoop(e) {
                ...
                0 !== e.length &&
                    ...
                    setTimeout(() => {
                        if (!this.paused) {
                            ...
                            e < 0
                                ? this._bounce
                                    ? ((this._direction = 1), (e = 1))
                                    : (e = this._frames.length - 1)
                                : e >= this._frames.length &&
                                  (this._bounce
                                      ? ((this._direction = -1),
                                        (e = this._frames.length - 2))
                                      : (e = 0)),
                                (this.frame = e),
            ...
            next() {
                ++this.frame >= this._frames.length && (this.frame = 0),
                ...
                0 !== e.length &&
                    ...
                    this._rendered != t &&
                        requestAnimationFrame(() => {
                            this._ctx.putImageData(this._frames[t], 0, 0),
                                (this._rendered = t),
                                this.dispatchEvent(
            ...
            renderFrame(e) {
                for (; this._decoded < e; ) {
                    ...
                    t > 0 &&
                        s.disposal < 2 &&
                        i.data.set(new Uint8ClampedArray(this._frames[t - 1].data)),
                        this._gif.decodeAndBlitFrameRGBA(t, i.data),
                        (this._frames[t] = i),
                        (this._delays[t] = 10 * s.delay),
                        (this._decoded = t)
                }
            }
            prerenderFrames(e) {
    ...
    ;(window.requestIdleCallback =
        ...
        window.WebComponents && window.WebComponents.ready
            ? s()
            : window.addEventListener('WebComponentsReady', s)
})()
