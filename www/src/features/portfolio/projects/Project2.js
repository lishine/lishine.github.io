               ...
               >
                   <Box mie={5}>
                       ...
                       <SubLink>
                           ...
                           <NavLink
                               target="_blank"
                               href="https://github.com/lishine/demo2"
                           />
                       </SubLink>
                       <SubLink>
                           Demo:&nbsp;
                           <NavLink
                               target="_blank"
                               href="https://sbs2.golden-minutes.com"
                           />
                       </SubLink>
                   </Box>
                   <Grid
                   ...
                   >
                       ...
                       <DoesWrapper>
                           ...
                           <DoesList>
                               ...
                               <DoesItem>
                                   React state management: Easy-Peasy (Redux +
                                   React-hooks)
                               </DoesItem>
                               <DoesItem>
                               ...
                               <DoesItem>
                                   Latest CSS tech: Flex, Grid, custom and logical CSS
                                   properties
                               </DoesItem>
                           </DoesList>
                       </DoesWrapper>
