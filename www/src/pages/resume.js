        ...
        >
            <Box>
                ...
                <P>
                    ...
                    <br />
                    <br />
                    Done 2 <strong>Next.js projects</strong> using Css-In-Js according to
                    design
                    <br />
                    ...
                    <strong>Clojurescript</strong> on web and mobile clients and Node.js
                    on AWS Lambda + Dynamodb + Redshift/Postgresql.
                    <br />
                    Developed web app using React + Meteor
                    <br />
                    <br />
                    Mostly I like{' '}
                    <Span fontStyle="italic"> Front-end and state management </Span>.
                    <br />I care about the time I am payed for and use it for efficient
                    production.{' '}
                    <strong>I care the most about code quality and refactor a lot</strong>
                    , adhere to <Span fontStyle="italic"> DRY, KISS, YAGNI</Span> software
                    principles,{' '}
                    <Span fontStyle="italic"> can work autonomously and in a team </Span>.
                ...
                <Grid as="dl" gridAutoFlow="row" gridTemplateColumns="150px 1fr">
                    ...
                    <DD>
                        ...
                        <UL>
                            <LI>
                                Full Stack desktop and mobile Apps built from the ground
                                up
                            </LI>
                            <LI>
                                Projects in detail:
